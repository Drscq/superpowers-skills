...
```bash
grep -i "worktree.*director" .gemini/GEMINI.md 2>/dev/null
```
...
**Called by:**
- **`superpowers-brainstorming`** - When design is approved and implementation follows
- **`superpowers-subagent-driven-development`** - Before executing any tasks
- **`superpowers-executing-plans`** - Before executing any tasks

**Pairs with:**
- **`superpowers-finishing-a-development-branch`** - Cleanup after work complete
