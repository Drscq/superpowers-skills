...
4. If no concerns: Create task checklist in `task.md` and proceed

### Step 2: Execute Batch
**Default: First 3 tasks**

For each task:
1. Mark as in_progress in `task.md`
...
- Read the `superpowers-finishing-a-development-branch` skill
